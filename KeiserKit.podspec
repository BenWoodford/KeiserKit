#
#  Be sure to run `pod spec lint KeiserKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Ben Woodford"
  # s.authors            = { "Ben Woodford" => "me@benwoodford.co.uk" }
  ...
  s.source       = { :git => "https://github.com/BenWoodford/KeiserKit.git", :tag => "0.0.1" }
